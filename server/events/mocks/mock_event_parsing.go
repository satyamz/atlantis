...
func (mock *MockEventParsing) GetBitbucketCloudPullEventType(_param0 string, _param1 string, _param2 string) models.PullRequestEventType {
	if mock == nil {
...
func (verifier *VerifierMockEventParsing) GetBitbucketCloudPullEventType(_param0 string, _param1 string, _param2 string) *MockEventParsing_GetBitbucketCloudPullEventType_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2}
