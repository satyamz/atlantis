...
func (mock *MockClient) PullIsMerged(repo models.Repo, pull models.PullRequest, vcsstatusname string) (bool, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockClient().")
	}
	params := []pegomock.Param{repo, pull, vcsstatusname}
...
func (verifier *VerifierMockClient) PullIsMerged(repo models.Repo, pull models.PullRequest, vcsstatusname string) *MockClient_PullIsMerged_OngoingVerification {
	params := []pegomock.Param{repo, pull, vcsstatusname}
...
func (c *MockClient_PullIsMerged_OngoingVerification) GetCapturedArguments() (models.Repo, models.PullRequest, string) {
	repo, pull, vcsstatusname := c.GetAllCapturedArguments()
	return repo[len(repo)-1], pull[len(pull)-1], vcsstatusname[len(vcsstatusname)-1]
}

func (c *MockClient_PullIsMerged_OngoingVerification) GetAllCapturedArguments() (_param0 []models.Repo, _param1 []models.PullRequest, _param2 []string) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
		_param0 = make([]models.Repo, len(c.methodInvocations))
		for u, param := range params[0] {
